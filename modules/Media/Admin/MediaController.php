...
class MediaController extends Controller
{
    ...
    public static function validateFile($file, $group = "default")
    {
        ...
        if (!isset($uploadConfigs[$group])) {
            throw new \Exception(__("File type not found"));
        }
    ...
    public function getLists(Request $request)
    {
        ...
        $file_type = $request->input('type', 'default');
        ...
        $files = $model->offset($offset)->orderBy('id', 'desc')->paginate(32);
        // Count
        $total = $files->total();
        ...
        return $this->sendSuccess([
            'data'      => MediaResource::collection($files->items()),
            'total'     => $total,
            'totalPage' => $totalPage
        ]);
    }
