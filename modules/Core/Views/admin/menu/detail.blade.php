                            ...
                            <Draggable-Tree :value="items" draggable cross-tree :triggerClass="triggerClass">
                                <div slot-scope="{node,index, path, tree}" class="nestable-item-content" >
                                    ...
                                    <div class="menu-info" v-show="node._open">
                                        ...
                                        <div class="row" >
                                            <div class="col-md-2">
                                                <input type="radio" v-model="node.mega_menu" class="form-control input-sm">
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{__('1st Image')}}</label>
                                                    <div class="form-controls form-group-image">
                                                        {{-- {!! \Modules\Media\Helpers\FileHelper::fieldUpload('mega_menu_image_1',@{{node.mega_menu_image_1}}) !!} --}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{__('2nd Image')}}</label>
                                                    <div class="form-controls form-group-image">
                                                        {{-- {!! \Modules\Media\Helpers\FileHelper::fieldUpload('mega_menu_image_2',@{{node.mega_menu_image_2}}) !!} --}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
