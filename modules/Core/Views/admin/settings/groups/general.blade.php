        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="">{{__("Contact Phone")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="contact_phone" value="{{setting_item_with_lang('contact_phone',request()->query('lang'))}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="">{{__("Contact Whatsapp Phone")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="contact_whatsapp_phone" value="{{setting_item_with_lang('contact_whatsapp_phone',request()->query('lang'))}}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label>{{ __('Footer Bottom Menu List') }}</label>
                    <div class="form-controls">
                        <div class="form-group-item">
                            <div class="form-group-item">
                                <div class="g-items-header">
                                ...
                                <div class="g-items">
                                    ...
                                    ?>
                                    @foreach ($footer_bottom_menu as $key => $item)
                                        <div class="item" data-number="{{ $key }}">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <input type="text"
                                                        name="footer_bottom_menu[{{ $key }}][title]"
                                                        class="form-control" value="{{ $item['title'] }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text"
                                                        name="footer_bottom_menu[{{ $key }}][link]"
                ...
                <div class="form-group">
                    <label>{{ __('Footer Bottom Image') }}</label>
                    <div class="form-controls form-group-image">
                        {!! \Modules\Media\Helpers\FileHelper::fieldUpload('footer_bottom_image', setting_item('footer_bottom_image')) !!}
                    </div>
                </div>
                <div class="form-group">
                    <label>{{ __('Footer Social Link') }}</label>
                    <div class="form-controls">
                        <div class="form-group-item">
                            <div class="form-group-item">
                                <div class="g-items-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">{{ __('Color Class') }}</div>
                                        <div class="col-md-2">{{ __('Icon Class ') }}</div>
                                        <div class="col-md-1"></div>
                                    </div>
                                </div>
                                <div class="g-items">
                                    ...
                                    ?>
                                    @foreach ($footer_bottom_social as $key => $item)
                                        <div class="item" data-number="{{ $key }}">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <input type="text"
                                                        name="footer_bottom_social[{{ $key }}][title]"
                                                        class="form-control" value="{{ $item['title'] }}">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text"
                                                        name="footer_bottom_social[{{ $key }}][link]"
                                                        class="form-control" value="{{ $item['link'] }}">
                                                </div>
                                                <div class="col-md-2">
                                                    <select class="form-control"
                                                        name="footer_bottom_social[{{ $key }}][color]">
                                                        <option @if (!empty($item['color']) && $item['color'] == 'col_fb') selected @endif
                                                            value="col_fb">Facebook Color</option>
                                                        <option @if (!empty($item['color']) && $item['color'] == 'col_twt') selected @endif
                                                            value="col_twt">Twitter Color</option>
                                                        <option @if (!empty($item['color']) && $item['color'] == 'col_lin') selected @endif
                                                            value="col_lin">Linkedin</option>
                                                        <option @if (!empty($item['color']) && $item['color'] == 'col_ytb') selected @endif
                                                            value="col_ytb">Youtube</option>
                                                        <option @if (!empty($item['color']) && $item['color'] == 'col_istg') selected @endif
                                                            value="col_istg">planatrip</option>
                                                        <option @if (!empty($item['color']) && $item['color'] == 'col_wds') selected @endif
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control"
                                                        name="footer_bottom_social[{{ $key }}][icon]">
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-facebook') selected @endif
                                                            value="fa fa-facebook"><i class="fa fa-facebook"></i>
                                                        </option>
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-twitter') selected @endif
                                                            value="fa fa-twitter"><i class="fa fa-twitter"></i>
                                                        </option>
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-linkedin') selected @endif
                                                            value="fa fa-linkedin"><i class="fa fa-linkedin"></i>
                                                        </option>
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-youtube-play') selected @endif
                                                            value="fa fa-youtube-play"><i
                                                                class="fa fa-youtube-play"></i></option>
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-file-image-o') selected @endif
                                                            value="fa fa-file-image-o"><i
                                                                class="fa fa-file-image-o"></i></option>
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-wordpress') selected @endif
                                                            value="fa fa-wordpress"><i class="fa fa-wordpress"></i>
                                                        </option>
                                                        <option @if (!empty($item['icon']) && $item['icon'] == 'fa fa-instagram') selected @endif
