...
class HotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            'rows'               => $list,
            'hotel_category' => $this->hotelCategoryClass::where('status', 'publish')->with(['translations'])->get()->toTree(),
            'hotel_institutional' => $this->hotelInstitutionalClass::where('status', 'publish')->with(['translations'])->get()->toTree(),
    ...
    {
        $row = $this->hotelClass::where('slug', $slug)->with(['location','translations','hasWishList', 'category', 'institutional'])->first();;
