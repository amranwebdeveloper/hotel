...
Route::group(['prefix'=>config('hotel.hotel_route_prefix')],function(){
    ...
    Route::get('/loadDates','AvailabilityController@loadDates')->name('hotel.frontend.layouts.details.room-availability.loadDates');
});
...
Route::get('/hotel-category', 'CategoryController@index')->name('hotel.category.index');

Route::group(['prefix' => config('hotel.hotel_cat_route_prefix')], function () {
    Route::get('/{slug}', 'CategoryController@detail')->name('hotel.category.detail');
});

Route::get('/institutional', 'InstitutionalController@index')->name('hotel.institutional.index');
