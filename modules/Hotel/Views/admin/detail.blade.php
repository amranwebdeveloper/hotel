                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        @if (is_default_lang())
                            ...
                            <div class="panel">
                                <div class="panel-title"><strong>{{ __('Institutional') }} *</strong></div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="terms-scrollable">
                                            <?php
                                            ...
                                            ?>
                                            <label class="term-item">
                                                <input {{ $checked }} type="checkbox" name="institutions[]"
                                                       value="{{ $institutional->id }}">
                                                <span class="term-name">{{ $prefix . ' ' . $institutional->name }}</span>
                                            </label>
                                            <?php
