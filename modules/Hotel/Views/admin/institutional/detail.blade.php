    ...
    <form action="{{route('hotel.admin.institutional.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Edit: ').$row->name : __('Add new institutional')}}</h1>
                </div>
                <div class="">
                    @if($row->slug)
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                <h3 class="panel-body-title">{{__("Institutional Content")}}</h3>
                                @include('Hotel::admin/institutional/form')
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
