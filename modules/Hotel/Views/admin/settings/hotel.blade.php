                        ...
                        <div class="form-controls">
                            <div class="form-group-item">
                                <div class="g-items-header">
                                    <div class="row">
                                        <div class="col-md-5">{{__("icon")}}</div>
                                        ...
                                        <div class="item" data-number="{{$key}}">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" value="{{$item->icon}}" placeholder="Ex: fa fa-facebook" name="hotel_review_stats[{{$key}}][icon]" class="form-control">
                                    ...
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" __name__="hotel_review_stats[__number__][icon]" class="form-control" value="" placeholder="{{__('Ex: fa fa-facebook')}}">
                                            </div>
                                            <div class="col-md-5">
