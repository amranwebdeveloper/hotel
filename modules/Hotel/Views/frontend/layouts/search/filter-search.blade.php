...
<div class="bravo_filter">
    <div class="filter-section">
        <div class="filter-map-btn">
            <img src="{{ URL('/')}}/uploads/demo/hotel/search-map.jpg" alt="">
            <a href="{{ route("hotel.search",['_layout'=>'map']) }}"><i class="icofont-ui-map"></i>&nbsp;{{__("Show on map")}}</a>
        </div>
        <div class="filter-head">
            <span class="filter-hotel">  @if($rows->total() > 1)
    ...
    <form action="{{ route("hotel.search") }}" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                ...
                @if(count($hotel_category) > 3 and empty($current_category_ids))
