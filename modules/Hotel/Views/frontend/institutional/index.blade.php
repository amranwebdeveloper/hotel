    ...
    <section class="our-listing pb30-991">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_content style2">
                        <h2 class="breadcrumb_title">{{ __('All Institutions') }}</h2>
                        <ol class="breadcrumb">
            ...
            <div class="row hotel-categories">
                @if (!empty($hotelInstitutionalHeader))
                    @foreach ($hotelInstitutionalHeader as $institutionalHeader)
                        <div class="col-sm-6 col-md-4">
                            <a href="{{ $institutionalHeader->getDetailUrl() }}">
                                <div class="icon-box">
                                    @if ($institutionalHeader->icon_image_id)
                                        <img src="{{ get_file_url($institutionalHeader->icon_image_id, 'full')}}" alt="{{ $institutionalHeader->name }}" />
                                    @endif
                                    <div class="content-details">
                                        <div class="title">{{ $institutionalHeader->name }}</div>
                                    </div>
                                </div>
                            </a>
                        </div>
