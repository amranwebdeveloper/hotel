...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard' }} - {{ setting_item('site_title') ?? 'Tatil Benim' }}</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 copy-right">
                            {{ date('Y') }} &copy; {{ __('Tatil Benim by') }} <a
                                href="{{ __('https://amranwebdeveloper.com/') }}"
                                target="_blank">{{ __('Amranwebdeveloper') }}</a>
                        </div>
                        <div class="col-md-6">
                            <div class="text-md-right footer-links d-none d-sm-block">
                                <a href="{{ __('https://www.amranwebdeveloper.com') }}"
