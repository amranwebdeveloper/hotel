                ...
                <?php if(!empty($cats)): ?>
                    <li class="list-inline-item mb30-767">
                        <select class="selectpicker show-tick" onchange="this.form.submit()" name="category_id">
                            <option><?php echo e(__('Categories : All')); ?></option>
                            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>"
                                    <?php if(request()->input('category_id') == $cat->id): ?> selected <?php endif; ?>><?php echo e($cat->name); ?>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/frontend/vendorHotel/loop-list.blade.php ENDPATH**/ ?>