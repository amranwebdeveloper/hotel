    ...
    <div class="panel-body">
        ...
        <?php if(is_default_lang()): ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Main Category")); ?></label>
                        <div class="">
                ...
                <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(__("Main Institutional")); ?></label>
                            <div class="">
...
<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Other Details")); ?></strong></div>
    <div class="panel-body">

        <div class="form-group">
            <label class="control-label"><?php echo e(__("General Features")); ?> <?php echo e(__("Note: Features Select From Attributes")); ?></label>
            <div class="">
                <textarea name="general_features" class="form-control"><?php echo e($translation->general_features); ?></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="control-label"><?php echo e(__("Facility Activities")); ?> <?php echo e(__("Note: Features Select From Attributes")); ?></label>
            <div class="">
                <textarea name="facility_activities" class="form-control"><?php echo e($translation->facility_activities); ?></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="control-label"><?php echo e(__("Pool and Beach")); ?> <?php echo e(__("Note: Features Select From Attributes")); ?></label>
            <div class="">
                <textarea name="pool_and_beach" class="form-control"><?php echo e($translation->pool_and_beach); ?></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="control-label"><?php echo e(__("Honeymoon")); ?> <?php echo e(__("Note: Features Select From Attributes")); ?></label>
            <div class="">
                <textarea name="honeymoon" class="form-control"><?php echo e($translation->honeymoon); ?></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="control-label"><?php echo e(__("Concept Features")); ?></label>
            <div class="">
                <textarea name="concept_features" class="d-none has-ckeditor" cols="30" rows="10"><?php echo e($translation->concept_features); ?></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="control-label"><?php echo e(__("Important Notes")); ?></label>
            <div class="">
                <textarea name="important_notes" class="d-none has-ckeditor" cols="30" rows="10"><?php echo e($translation->important_notes); ?></textarea>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/admin/hotel/content.blade.php ENDPATH**/ ?>