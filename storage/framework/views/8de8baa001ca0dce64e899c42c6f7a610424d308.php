	...
	<div class="booking-review-content">
		...
		<div class="review-section">
			<ul class="review-list">
				...
				<?php endif; ?>
                <?php $children_age = $booking->getJsonMeta('children_age'); ?>
				<?php if(!empty($children_age)): ?>
					<li>
						<div class="label-title"><strong><?php echo e(__("Children Ages:")); ?></strong></div>
					</li>
					<li class="no-flex">
						<ul>
                            <?php  $child=1; ?>
							<?php $__currentLoopData = $children_age; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="label">
                                        <?php echo e(__('Child ')); ?> <?php echo e($child); ?>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>