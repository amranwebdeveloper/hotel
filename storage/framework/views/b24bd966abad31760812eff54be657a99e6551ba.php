			...
			<div class="container context">
                <div class="copy-right-menu">
                    <div class="copy-right-menu-list">
                        ...
                        <?php if($footer_bottom_menus = setting_item_with_lang("footer_bottom_menu")): ?>
                            <?php $footer_bottom_menus = json_decode($footer_bottom_menus); ?>
                            <?php $__currentLoopData = $footer_bottom_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a class="brlft" href="<?php echo $item->link; ?>"><span><?php echo e($item->title); ?></span></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="row justify-content-end footer-logos">
                    <div class="col-7">
                        <?php if($bg = get_file_url(setting_item("footer_bottom_image"),"full")): ?>
                            <img src="<?php echo e($bg); ?>" data-src="<?php echo e($bg); ?>" class="wd100" alt="ssl_img">
                        <?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Layout/parts/footer.blade.php ENDPATH**/ ?>