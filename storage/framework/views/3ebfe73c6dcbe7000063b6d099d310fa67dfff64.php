                    ...
                    <div class="col-md-4 pl-md-1">
                        <div class="form-group">
                            ...
                            <div class="dropdown-menu select-guests-dropdown" >
                                ...
                                <div class="dropdown-item-row">
                                    <div class="row">
                                        <div class="label col-md-6"><?php echo e(__('Children')); ?></div>
                                        <div class="val col-md-6">
                                            ...
                                            <div class="col-md-6 children_age" v-for="child_age in children_age">
                                                <select class="form-control" v-model="child_age.age">
                                                    <option value=""><?php echo e(__('Child Age')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-9 room-detail-box ">
                                                ...
                                                <ul class="room-meta">
                                                    <li v-if="room.size_html">
                                                        <div class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo e(__('Room Footage')); ?>">
                                                            <i class="input-icon field-icon icofont-ruler-compass-alt"></i> <?php echo e(__('Room Footage')); ?>: <span v-html="room.size_html"></span>
                                                        </div>
                                                    </li>
                                                    <li v-if="room.beds_html">
                                                        <div class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo e(__('No. Beds')); ?>">
                                                            <i class="input-icon field-icon icofont-hotel"></i> <?php echo e(__('No. Beds')); ?>: <span v-html="room.beds_html"></span>
                                                        </div>
                                                    </li>
                                                    <li v-if="room.adults_html">
                                                        <div class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo e(__('No. Adults')); ?>">
                                                            <i class="input-icon field-icon icofont-users-alt-4"></i> <?php echo e(__('No. Adults')); ?>: <span v-html="room.adults_html"></span>
                                                        </div>
                                                    </li>
                                                    <li v-if="room.children_html">
                                                        <div class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo e(__('No. Children')); ?>">
                                                            <i class="input-icon field-icon fa-child fa"></i> <?php echo e(__('No. Children')); ?>: <span v-html="room.children_html"></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="col-price clear">
                                                ...
                                                <a class="" data-toggle="modal" :data-target="'#modal_room_availability_'+room.id">
                                                    <i class="icofont-ui-calendar"></i> <?php echo e(__('Room Availability Calendar')); ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="list-attributes">
                                                                    <div class="attribute-item" v-for="term in room.terms">
                                                                        <h4 class="title">{{ term.parent.title }}</h4>
                                                                        <?php if ($__env->exists("Hotel::frontend.layouts.details.room-availability")) echo $__env->make("Hotel::frontend.layouts.details.room-availability", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="alert alert-danger" role="alert">
                                        <?php echo e(__('You can only make reservations with our customer representative for the dates you have chosen in this facility. You can get more detailed information from')); ?> <a href="tel:<?php echo e(setting_item("contact_phone")); ?>"><?php echo e(setting_item("contact_phone")); ?></a> .
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/frontend/layouts/details/hotel-rooms.blade.php ENDPATH**/ ?>