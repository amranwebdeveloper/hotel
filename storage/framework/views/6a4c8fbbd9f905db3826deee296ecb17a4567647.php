...
<div class="bravo_filter">
    <div class="filter-section">
        <div class="filter-map-btn">
            <img src="<?php echo e(URL('/')); ?>/uploads/demo/hotel/search-map.jpg" alt="">
            <a href="<?php echo e(route("hotel.search",['_layout'=>'map'])); ?>"><i class="icofont-ui-map"></i>&nbsp;<?php echo e(__("Show on map")); ?></a>
        </div>
        <div class="filter-head">
            <span class="filter-hotel">  <?php if($rows->total() > 1): ?>
    ...
    <form action="<?php echo e(route("hotel.search")); ?>" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            <div class="item-title">
                <h3><?php echo e(__("Guest Rating")); ?></h3>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
        ...
        <div class="g-filter-item">
            <div class="item-title">
                <h3><?php echo e(__("Hotel Locations")); ?></h3>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
                ...
                <?php if(count($hotel_category) > 3 and empty($current_category_ids)): ?>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>