                                ...
                                <div class="col-md-4 d-none">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc"><?php echo e(__("Updater Tatil Benim")); ?></span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc"><?php echo e(__("Plugins for Tatil Benim")); ?></span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc"><?php echo e(__("Clear Cache for Tatil Benim")); ?></span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Core/Views/admin/tools/index.blade.php ENDPATH**/ ?>