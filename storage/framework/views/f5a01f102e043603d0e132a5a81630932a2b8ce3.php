    ...
    <?php if(!empty($hotel_map_search_fields)): ?>
        <?php $__currentLoopData = $hotel_map_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php switch($field['field']):
                ...
                <?php break; ?>
                <?php case ('category'): ?>
                    <?php echo $__env->make('Hotel::frontend.layouts.search-map.fields.category', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php break; ?>
                <?php case ('attr'): ?>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/frontend/layouts/search-map/form-search-map.blade.php ENDPATH**/ ?>