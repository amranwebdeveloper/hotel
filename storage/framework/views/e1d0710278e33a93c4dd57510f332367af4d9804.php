<?php if(!empty($seo_meta)): ?>
    ...
    <?php
        ...
        if (!empty($page_title) and empty($seo_meta['is_homepage'])) {
            $page_title .= ' - ' . setting_item_with_lang('site_title', false, 'Tatil Benim');
        }
        if (empty($page_title)) {
            $page_title = setting_item_with_lang('site_title', false, 'Tatil Benim');
        }
...
<?php endif; ?>
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Layout/parts/seo-meta.blade.php ENDPATH**/ ?>