                    ...
                    <div class="col-lg-5">
                        <div class="review-box-score">
                            <div class="review-score">
                                <?php echo e($review_score['score_total']); ?><span class="per-total">/10</span>
                            </div>
                                    ...
                                    <div class="form-group review-items">
                                        <?php $__currentLoopData = $tour_review_stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="item">
                                                ...
                                                <div class="rates">
                                                    <i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i><i class="fa fa-star-o grey"></i>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
...
<?php endif; ?>
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Review/Views/frontend/form.blade.php ENDPATH**/ ?>