...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - <?php echo e(setting_item('site_title') ?? 'Tatil Benim'); ?></title>
...
<body
    class="<?php echo e($enable_multi_lang ?? '' ? 'enable_multi_lang' : ''); ?> <?php if(setting_item('site_enable_multi_lang')): ?> site_enable_multi_lang <?php endif; ?>">
    <div id="app">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 copy-right">
                            <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Tatil Benim by')); ?> <a
                                href="<?php echo e(__('https://amranwebdeveloper.com/')); ?>"
                                target="_blank"><?php echo e(__('Amranwebdeveloper')); ?></a>
                        </div>
                        <div class="col-md-6">
                            <div class="text-md-right footer-links d-none d-sm-block">
                                <a href="<?php echo e(__('https://www.amranwebdeveloper.com')); ?>"
                                    target="_blank"><?php echo e(__('About Us')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Layout/admin/app.blade.php ENDPATH**/ ?>