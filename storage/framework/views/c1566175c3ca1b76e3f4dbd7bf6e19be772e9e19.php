        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class=""><?php echo e(__("Contact Phone")); ?></label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="contact_phone" value="<?php echo e(setting_item_with_lang('contact_phone',request()->query('lang'))); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class=""><?php echo e(__("Contact Whatsapp Phone")); ?></label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="contact_whatsapp_phone" value="<?php echo e(setting_item_with_lang('contact_whatsapp_phone',request()->query('lang'))); ?>">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label><?php echo e(__('Footer Bottom Menu List')); ?></label>
                    <div class="form-controls">
                        <div class="form-group-item">
                            <div class="form-group-item">
                                <div class="g-items-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><?php echo e(__('URL')); ?></div>
                                        <div class="col-md-1"></div>
                                    </div>
                                </div>
                                <div class="g-items">
                                    <?php
                                    $footer_bottom_menu = setting_item_with_lang('footer_bottom_menu', request()->query('lang'));
                                    if (!empty($footer_bottom_menu)) {
                                        $footer_bottom_menu = json_decode($footer_bottom_menu, true);
                                    }
                                    if (empty($footer_bottom_menu) or !is_array($footer_bottom_menu)) {
                                        $footer_bottom_menu = [];
                                    }
                                    ?>
                                    <?php $__currentLoopData = $footer_bottom_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item" data-number="<?php echo e($key); ?>">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <input type="text"
                                                        name="footer_bottom_menu[<?php echo e($key); ?>][title]"
                                                        class="form-control" value="<?php echo e($item['title']); ?>">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text"
                                                        name="footer_bottom_menu[<?php echo e($key); ?>][link]"
                                                        class="form-control" value="<?php echo e($item['link']); ?>">
                                                </div>
                                                <div class="col-md-1">
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <input type="text" __name__="footer_bottom_menu[__number__][title]"
                                                    class="form-control" value="">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" __name__="footer_bottom_menu[__number__][link]"
                                                    class="form-control" value="">
                                            </div>
                                            <div class="col-md-1">
                                                <span class="btn btn-danger btn-sm btn-remove-item"><i
                ...
                <div class="form-group">
                    <label><?php echo e(__('Footer Bottom Image')); ?></label>
                    <div class="form-controls form-group-image">
                        <?php echo \Modules\Media\Helpers\FileHelper::fieldUpload('footer_bottom_image', setting_item('footer_bottom_image')); ?>

                    </div>
                </div>
                <div class="form-group">
                    <label><?php echo e(__('Footer Social Link')); ?></label>
                    <div class="form-controls">
                        <div class="form-group-item">
                            <div class="form-group-item">
                                <div class="g-items-header">
                                    <div class="row">
                                        <div class="col-md-3"><?php echo e(__('Title')); ?></div>
                                        <div class="col-md-4"><?php echo e(__('URL')); ?></div>
                                        <div class="col-md-2"><?php echo e(__('Color Class')); ?></div>
                                        <div class="col-md-2"><?php echo e(__('Icon Class ')); ?></div>
                                        <div class="col-md-1"></div>
                                    </div>
                                </div>
                                <div class="g-items">
                                    <?php
                                    $footer_bottom_social = setting_item_with_lang('footer_bottom_social', request()->query('lang'));
                                    if (!empty($footer_bottom_social)) {
                                        $footer_bottom_social = json_decode($footer_bottom_social, true);
                                    }
                                    if (empty($footer_bottom_social) or !is_array($footer_bottom_social)) {
                                        $footer_bottom_social = [];
                                    }
                                    ?>
                                    <?php $__currentLoopData = $footer_bottom_social; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item" data-number="<?php echo e($key); ?>">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <input type="text"
                                                        name="footer_bottom_social[<?php echo e($key); ?>][title]"
                                                        class="form-control" value="<?php echo e($item['title']); ?>">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text"
                                                        name="footer_bottom_social[<?php echo e($key); ?>][link]"
                                                        class="form-control" value="<?php echo e($item['link']); ?>">
                                                </div>
                                                <div class="col-md-2">
                                                    <select class="form-control"
                                                        name="footer_bottom_social[<?php echo e($key); ?>][color]">
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_fb'): ?> selected <?php endif; ?>
                                                            value="col_fb">Facebook Color</option>
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_twt'): ?> selected <?php endif; ?>
                                                            value="col_twt">Twitter Color</option>
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_lin'): ?> selected <?php endif; ?>
                                                            value="col_lin">Linkedin</option>
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_ytb'): ?> selected <?php endif; ?>
                                                            value="col_ytb">Youtube</option>
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_istg'): ?> selected <?php endif; ?>
                                                            value="col_istg">planatrip</option>
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_wds'): ?> selected <?php endif; ?>
                                                            value="col_wds">Wordpress</option>
                                                        <option <?php if(!empty($item['color']) && $item['color'] == 'col_istg'): ?> selected <?php endif; ?>
                                                            value="col_istg">Instagram</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                    <select class="form-control"
                                                        name="footer_bottom_social[<?php echo e($key); ?>][icon]">
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-facebook'): ?> selected <?php endif; ?>
                                                            value="fa fa-facebook"><i class="fa fa-facebook"></i>
                                                        </option>
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-twitter'): ?> selected <?php endif; ?>
                                                            value="fa fa-twitter"><i class="fa fa-twitter"></i>
                                                        </option>
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-linkedin'): ?> selected <?php endif; ?>
                                                            value="fa fa-linkedin"><i class="fa fa-linkedin"></i>
                                                        </option>
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-youtube-play'): ?> selected <?php endif; ?>
                                                            value="fa fa-youtube-play"><i
                                                                class="fa fa-youtube-play"></i></option>
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-file-image-o'): ?> selected <?php endif; ?>
                                                            value="fa fa-file-image-o"><i
                                                                class="fa fa-file-image-o"></i></option>
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-wordpress'): ?> selected <?php endif; ?>
                                                            value="fa fa-wordpress"><i class="fa fa-wordpress"></i>
                                                        </option>
                                                        <option <?php if(!empty($item['icon']) && $item['icon'] == 'fa fa-instagram'): ?> selected <?php endif; ?>
                                                            value="fa fa-instagram"><i class="fa fa-instagram"></i>
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-1">
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text"
                                                    __name__="footer_bottom_social[__number__][title]"
                                                    class="form-control" value="">
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text"
                                                    __name__="footer_bottom_social[__number__][link]"
                                                    class="form-control" value="">
                                            </div>
                                            <div class="col-md-2">
                                                <select class="form-control"
                                                    __name__="footer_bottom_social[__number__][color]">
                                                    <option value="col_fb">Facebook Color</option>
                                                    <option value="col_twt">Twitter Color</option>
                                                    <option value="col_lin">Linkedin</option>
                                                    <option value="col_ytb">Youtube</option>
                                                    <option value="col_istg">planatrip</option>
                                                    <option value="col_wds">Wordpress</option>
                                                    <option value="col_istg">Instagram</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                <select class="form-control"  __name__="footer_bottom_social[__number__][icon]">
                                                    <option value="fa fa-facebook"><i class="fa fa-facebook"></i>  facebook </option>
                                                    <option value="fa fa-twitter"><i class="fa fa-twitter"></i> twitter</option>
                                                    <option value="fa fa-linkedin"><i class="fa fa-linkedin"></i> linkedin </option>
                                                    <option value="fa fa-youtube-play"><i class="fa fa-youtube-play"></i> youtube</option>
                                                    <option value="fa fa-file-image-o"><i class="fa fa-file-image-o"></i> other</option>
                                                    <option value="fa fa-wordpress"><i class="fa fa-wordpress">wordpress</i> </option>
                                                    <option value="fa fa-instagram"><i  class="fa fa-instagram"></i> instagram</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                                                <span class="btn btn-danger btn-sm btn-remove-item"><i
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Core/Views/admin/settings/groups/general.blade.php ENDPATH**/ ?>