                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                                    ...
                                    <div class="form-group">
                                        <div class="terms-scrollable">
                                            ...
                                            <label class="term-item">
                                                <input <?php echo e($checked); ?> type="checkbox" name="categories[]"
                                                       value="<?php echo e($category->id); ?>">
                                                <span class="term-name"><?php echo e($prefix . ' ' . $category->name); ?></span>
                                            </label>
                                            <?php
                            ...
                            <div class="panel">
                                <div class="panel-title"><strong><?php echo e(__('Institutional')); ?> *</strong></div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="terms-scrollable">
                                            <?php
                                            ...
                                            if(!empty($row->institutions)){
                                                foreach ($row->institutions as $cat){
                                                    if ($institutional->id == $cat->id){
                                                        $checked = 'checked';
                                                        break;
                                                    }
                                                }
                                            ...
                                            ?>
                                            <label class="term-item">
                                                <input <?php echo e($checked); ?> type="checkbox" name="institutions[]"
                                                       value="<?php echo e($institutional->id); ?>">
                                                <span class="term-name"><?php echo e($prefix . ' ' . $institutional->name); ?></span>
                                            </label>
                                            <?php
    ...
    <script>
        jQuery(function ($) {
            new BravoMapEngine('map_content', {
                disableScripts: true,
                fitBounds: true,
                center: [<?php echo e($row->map_lat ?? setting_item('map_lat_default',51.505 )); ?>, <?php echo e($row->map_lat ?? setting_item('map_lat_default',-0.09 )); ?>],
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amraezyf/hotel.amranwebdeveloper.com/modules/Hotel/Views/admin/detail.blade.php ENDPATH**/ ?>