...
jQuery(function ($) {
    ...
    $(".bravo-box-category-hotel").each(function () {
        $(this).find(".owl-carousel").owlCarousel({
            items: 4,
            loop: false,
            margin: 30,
    ...
    $(".bravo-offer-slider").each(function () {
        $(this).find(".owl-carousel").owlCarousel({
            items: 1,
            loop: true,
            nav: true,
...
jQuery(function(e){
    e(".form-group-item").each((function() {
        e(this);
        e(this).on("click", ".btn-remove-item", (function() {
            e(this).closest(".form-group-item").find(".g-items .item:last-child").remove()
        })), e(this).on("press", "input,select", (function() {
            var t = e(this).val();
            e(this).attr("value", t)
        }))
    })), e(".form-group-item .btn-add-item").click((function() {
        var t = e(this).closest(".form-group-item").find(".g-items"),
            n = e(this).closest(".form-group-item").find(".g-items .item:last-child").data("number");
        void 0 === n ? n = 0 : n++;
        var r = e(this).closest(".form-group-item").find(".g-more").html();
        r = (r = r.replace(/__name__=/gi, "name=")).replace(/__number__/gi, n), t.append(r), r.indexOf("dungdt-select2-field-lazy") > 0 && t.find(".dungdt-select2-field-lazy").each((function() {
