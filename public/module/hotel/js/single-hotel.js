        ...
        computed:{
            ...
            discount_price:function(){
                ...
                if (me.start_date !== "") {
                    ...
                    var duration_in_day = moment(endDate).diff(moment(startDate), 'days');
                    // for discount_by_night
                    if (me.discount_by_night != null) {
                        for (var ix in me.discount_by_night) {
                            var discount_day = me.discount_by_night[ix];
                            var discount_from=discount_day.from;
                            var discount_to=discount_day.to;
                            var discount_amount=discount_day.amount;
                            var discount_type=discount_day.type;
                            console.log('1 Discount Type: ' +discount_type);
                            if(discount_from <= duration_in_day && duration_in_day <= discount_to){
                                if(discount_type=='percent'){
                                    total += ((me.duration_in_day * me.price) * discount_amount)/100;
            ...
            doSubmit:function (e) {
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        discount_by_night:this.discount_by_night,
